        ...
        <div className="bg-chakra">
          <div className="container">
              <div className="row">
                  ...
                  <div className="col-12 col-md-6"> 
                    <h2>“Quando você consegue despertar a Kundalini,<br/>
                    ela começa a mover-se da sua mera potencialidade,<br/>
                    você de fato inicia um mundo totalmente diferente<br/>
                    do nosso mundo. Este é o mundo da eternidade." <br/>
                    <span>– Carl Jung</span>
                    </h2>
        ...
        <div className="bg-kundalini">
          <div className="container">
              <div className="row">
                ...
                <div className="col-12 col-md-3 offset-md-7">
        ...
        <div className="bg-vitroviano">
          <div className="container">
              <div className="row">
                ...
                <div className="col-12 vitroviano">
                ...
                <div className="col-12 col-md-4 box-yellow">
          ...
          <div className="container">
              <div className="row">
                <div className="col-12 col-md-8 offset-md-1 "> 
                  <p>O que quer que você esteja vivendo neste momento, é importante se entregar e
                  confiar no processo, já que esta é uma evolução de consciência natural, e a   
                  energia trabalha com inteligência.
                  </p>

                  <p>elas podem não entender o que você está passando e interpretar que você
                  esteja até mesmo com problemas psicológicos. Isso é compreensível, dado
                  que a sociedade moderna é relutante em falar sobre fenômenos espirituais e
                  energéticos e opta por ficar na ignorância quando o assunto está relacionado
                  Você pode decidir não falar sobre isto com pessoas que não confia, pois    
                  com ao que os olhos não podem ver.
                  </p> 

                  <p>Como já citado, este pode ser um processo difícil, porém, com o passar do 
                  tempo, vai levá-lo a atingir seu potencial completo, vivendo uma vida feliz,     
                  conectada e plena. 
                  </p>
                ...
                <div className="col-12 col-md 10">
                  <p>Confira mais artigos relacionados ao Despertar Espiritual & Kundalini 
                  acessando o M E N U na parte superior da página.</p>
                </div>

                <div className="col-12 col-md-5">

                  <p className="box-yellow">
                  Para obter suporte durante sua ativação e agendar uma sessão online, preencha o quadro abaixo ou envie um e-mail para andressa@andressa-awakeningminds.com 
                  </p>
                </div>
