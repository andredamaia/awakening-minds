    ...
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              <h3 className="add-top">Quais são as técnicas de terapia?</h3>
              ...
              <div className="red-box">
                <a href="#">Clique Aqui</a> para saber mais sobre os tratamentos oferecidos e descobrir qual é o 
                <a href="#">mais indicado para você.</a>
              </div>
