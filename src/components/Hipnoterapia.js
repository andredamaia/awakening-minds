    ...
    return (
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-8 offset-md-2">
                        ...
                        <span>Ele pode, inclusive, culpar as circunstâncias da vida ou outras pessoas, pois já que a pessoa é identificada com essa crença limitante, a mesma NÃO pode ser percebida.</span> 
        ...
        <div className="hip-iceberg">
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 col-md-8 red-box">
        ...
        <div className="hip-white">
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-8 offset-md-2"> 
                        <h2>Esteja pronto para se tornar a sua melhor versão, uma vez que você muda
                        seu mundo interior o seu mundo exterior seguirá essa transformação.</h2>
                    </div>
                </div>
            </div>    
        </div>
